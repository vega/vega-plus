...
var db = new duckdb.Database('scalable-vega.db');
...
for (i = 0; i < test_cases.length; i++) {
    ...
    var createTableQueryStr = createTableQueryStrFor(data_name, schema);
    ...
    var queryStr = format('insert into ' + data_name + ' (' + attrNamesStr + ') values %L', rows);
