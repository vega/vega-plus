...
export const crossfilter_spec = {
    ...
    "data": [
      {"name": "brush_store",
        "values": [
            {
            "unit": "child__column_time_layer_0",
            "fields": [{"field": "date", "channel": "x", "type": "R"}],
            "values": ["child__column_time_layer_1_bin_maxbins_20_time_extent"]
            }
        ]
      },
      {
      ...
      },
      {
        ...
        //   {
        //       "type": "filter",
        //       "expr": "datum.ARR_TIME > data(\"brush_store\")[0]['values'][0][0] && datum.ARR_TIME < data(\"brush_store\")[0]['values'][0][1]"
        //   },
          {
              "type": "filter",
              "expr": "datum[data(\"brush_store\")[0][\"fields\"][0][\"field\"]] > data(\"brush_store\")[0]['values'][0][0] && datum[data(\"brush_store\")[0][\"fields\"][0][\"field\"]] < data(\"brush_store\")[0]['values'][0][1]"
          },
          {
            "type": "aggregate",
            ...
            "on": [
              {
                ...
                "update": "brush_x[0] === brush_x[1] ? child__column_distance_layer_0_bin_maxbins_20_distance_extent : invert(\"child__column_distance_x\", brush_x)"
              }
            ]
          },
          {
        ...
        "signals": [
          ...
          },
          {
            ...
            "on": [
              {
                "events": {"signal": "brush_x"},
                "update": "brush_x[0] === brush_x[1] ? child__column_delay_layer_1_bin_maxbins_20_delay_extent : invert(\"child__column_delay_x\", brush_x)"
              }
            ]
          },
          {
        ...
        "signals": [
          ...
          },
          {
            ...
            "on": [
              {
                "events": {"signal": "brush_x"},
                "update": "brush_x[0] === brush_x[1] ? child__column_time_layer_1_bin_maxbins_20_time_extent : invert(\"child__column_time_x\", brush_x)"
              }
            ]
          },
          {
