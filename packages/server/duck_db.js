...
exports.Duck_Db = void 0;
var duckdb = require('duckdb');
var format = require('pg-format');
var Duck_Db = /** @class */ (function () {
    function Duck_Db() {
        this.db = new duckdb.Database("./database/scalable-vega.db");
    }
    Duck_Db.prototype.TypeFor = function (value) {
    ...
    Duck_Db.prototype.listToSQLTuple = function (l, keepQuotes) {
    ...
    Duck_Db.prototype.SchemaFor = function (dataObj) {
        var schema = {};
    ...
    Duck_Db.prototype.createTableQueryStrFor = function (tableName, schema) {
    ...
    Duck_Db.prototype.createTable = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.db.run(createTableQueryStr, function (err) {
    ...
    Duck_Db.prototype.importDatafile = function (name, filePath) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        console.log("import csv file");
                        _this.db.run("CREATE TABLE ".concat(name, " AS SELECT * FROM read_csv_auto('").concat(filePath, "');"), function (err) {
                            if (err) {
                                reject(err);
                            }
                            else {
    ...
    Duck_Db.prototype.getRows = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.db.all("SELECT * from ".concat(name), function (err, rows) {
                            if (err) {
                                reject(err);
                            }
                            else {
    ...
    Duck_Db.prototype.runQuery = function (sql, params) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
    ...
    Duck_Db.prototype.InsertTable = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.db.all(queryStr, function (err) {
                            if (err) {
                                reject(err);
                            }
                            else {
