import Constants from 'vega-expression';
import Functions from 'vega-expression';
...
export default function (opt) {
  ...
  //expr2sql.functions = functions;
  expr2sql.constants = constants;
